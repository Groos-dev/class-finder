...
skill_url="https://raw.githubusercontent.com/${REPO}/${skill_ref}/.claude/skill/find-class/SKILL.md"
skill_fallback_url="https://raw.githubusercontent.com/${REPO}/main/.claude/skill/find-class/SKILL.md"
